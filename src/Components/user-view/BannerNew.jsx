...
export default function Banner() {
  return (
    <div className="bg-gradient-to-br from-gray-50 to-white py-16 px-4 md:px-12 lg:px-20 relative overflow-hidden mt-6">
      {/* Decorative Elements */}
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2 space-y-8">
          ...
          <div className="text-5xl md:text-5xl lg:text-6xl font-bold leading-tight space-y-4 text-center flex flex-col justify-center items-center">
  <span className="">
    आपली सेवा   
  </span>
  
  <span className="block">
    आमचे कर्तव्य, तत्पर आणि {" "}
    <span className="relative inline-block z-10 mt-3">
      पारदर्शक!
      <img
        className="absolute h-14 z-[-10] -bottom-1"
        src={highBack}
      />
    </span>
  </span>
          ...
          <div className="flex flex-wrap gap-4 text-sm text-gray-600">
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 rounded-full bg-gray-100 flex items-center justify-center">✓</div>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <button className="px-8 py-4 bg-rose-500 hover:bg-rose-600 text-white rounded-xl font-medium transition-colors">
            प्रारंभ करा
            </button>
            </Link>
            ...
            <button className="px-8 py-4 bg-blue-50 hover:bg-blue-100 text-blue-600 rounded-xl font-medium flex items-center gap-2 transition-colors">
